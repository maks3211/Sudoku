...
//STRUKTURA CHYBA NIE POTRZEBNA- USUNOŁEM Z LINI 19,101 I 152 I DZIAŁA -- NIGDZIE NIE JEST ZMIENIANE "jest"-> wywalić strukture i dać zwykły vector int
...
/*class Sudoku{
 public:
    ...
    {
        cout <<"/n===============TOOOO ::"  <<removed_board[0][0].wartosc << endl;
        FillBoard(0, 0, full_board);
        removed_board = full_board;
        Usuwanie(removed_board, difficulty);
        Pokaz(full_board);
        cout <<"/n===============TOOOO ::"  <<full_board[0][0].wartosc << endl;
    }
  ...
  //  {
   ...
   // }
    ...
    if (possibleValues.size() == 0)
    {
       ...
       cout << "Przed mieszaniem: " << possibleValues[0] <<"..."<< possibleValues[1] << endl;
    random_shuffle(possibleValues.begin(), possibleValues.end());  //ZAMIENIC RANDOM SHUFFLE- NIE MA TEGO OD C17
    cout << "Po mieszaniem: " << possibleValues[0] <<"..."<< possibleValues[1] << endl;
